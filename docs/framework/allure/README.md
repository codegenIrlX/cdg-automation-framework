...
- [1. Введение](#1-введение)
  - [1.1. Что такое Allure и allure-pytest](#11-что-такое-allure-и-allure-pytest)
  - [1.2. Какие задачи решает и зачем нужен в автоматизации](#12-какие-задачи-решает-и-зачем-нужен-в-автоматизации)
  - [1.3. Преимущества визуализации отчётов](#13-преимущества-визуализации-отчётов)
- [2. Установка и настройка](#2-установка-и-настройка)
  - [2.1. Установка зависимостей](#21-установка-зависимостей)
  - [2.2. Интеграция в проект на pytest](#22-интеграция-в-проект-на-pytest)
  - [2.3. Пример `requirements.txt`](#23-пример-requirementstxt)
- [3. Сборка и просмотр отчёта](#3-сборка-и-просмотр-отчёта)
  - [3.1. Запуск тестов с генерацией результатов](#31-запуск-тестов-с-генерацией-результатов)
  - [3.2. Как сохранить отчёт и открыть локально](#32-как-сохранить-отчёт-и-открыть-локально)
- [4. Аннотации Allure](#4-аннотации-allure)
  - [4.1. `@allure.title("Название теста")`](#41-alluretitleназвание-теста)
  - [4.2. `@allure.description("Описание теста")`](#42-alluredescriptionописание-теста)
  - [4.3. Suites: `@allure.suite`, `@allure.sub_suite`, `@allure.parent_suite`](#43-suites-alluresuite-alluresubsuite-allureparentsuite)
  - [4.4. Severity: `@allure.severity(allure.severity_level.CRITICAL)`](#44-severity-allureseverityallureseveritylevelcritical)
  - [4.5. `@allure.tag`, `@allure.label`](#45-alluretag-allurelabel)
- [5. Степы (Steps) в отчёте](#5-степы-steps-в-отчёте)
  - [5.1. `@allure.step`](#51-allurestep)
  - [5.2. `with allure.step("...")` внутри тестов](#52-with-allurestep-внутри-тестов)
- [6. Примеры полного теста](#6-примеры-полного-теста)
  - [6.1. Простой тест с аннотациями и шагами](#61-простой-тест-с-аннотациями-и-шагами)
  - [6.2. Тест с фикстурами и вложенными шагами](#62-тест-с-фикстурами-и-вложенными-шагами)
- [7. Дополнительные возможности](#7-дополнительные-возможности)
  - [7.1. Скриншоты и вложения: `allure.attach`](#71-скриншоты-и-вложения-allureattach)
  - [7.2. Форматы вложений](#72-форматы-вложений)
- [8. Best practices и советы](#8-best-practices-и-советы)
  - [8.1. Как структурировать тесты и фикстуры](#81-как-структурировать-тесты-и-фикстуры)
  - [8.2. Использование `conftest.py` для мета-информации](#82-использование-conftestpy-для-мета-информации)
  - [8.3. Общие рекомендации по поддержанию читаемого отчёта](#83-общие-рекомендации-по-поддержанию-читаемого-отчёта)
- [9. Полезные ссылки](#9-полезные-ссылки)
  - [Официальная документация](#официальная-документация)
  - [GitHub-репозитории](#github-репозитории)
- [Приложение: быстрый старт](#приложение-быстрый-старт)
