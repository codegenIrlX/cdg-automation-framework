...
- [1. Документация](#1-документация)
    - [1.1. Схема системы](#11-схема-системы-figjam)
...
<a href="docs/diagrams/framework_flow.png">
  <img src="docs/diagrams/framework_flow.png" alt="Архитектура тестового фреймворка" width="900">
</a>
